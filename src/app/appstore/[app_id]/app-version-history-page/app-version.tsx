                ...
                <div className="flex-1 max-w-[1440px] px-4">
                    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 py-6 lg:py-8">
                        ...
                        <div className="flex flex-col lg:flex-row gap-6 lg:gap-4 min-h-[600px]">
                            {/* Left column */}
                            <div className="flex-1 lg:min-w-[260px] lg:max-w-sm flex flex-col justify-center">
                            ...
                            <div className="flex-1 lg:min-w-[300px]">
                                ...
                                <div className="text-center py-8 lg:py-12">
                                    <div className="mb-4">
                                        <svg
                                            className="w-12 h-12 lg:w-16 lg:h-16 text-gray-300 mx-auto"
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
                                    ...
                                    <p className="text-gray-600 text-sm sm:text-base">
                                        This app doesn't have any published
                                        versions yet.
                                    </p>
                                </div>
                            </div>
