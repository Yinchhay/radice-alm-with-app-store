...
export default function InformationTab({ projectId, onDataRefresh }: InformationTabProps) {
            ...
            <div className="space-y-2">
                {uploads.map((file, idx) => {
                    ...
                    if (file.file instanceof File) {
                        ...
                        previewUrl = getImageUrl(file.url);
    ...
    const handleContinue = async () => {
        ...
        try {
            ...
            // Refresh data after successful continue
            if (onDataRefresh) {
                onDataRefresh();
            }
    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                {(appType === "1" || appType === "3")&& (
                    <div className="mb-4">
                        <label className="block text-lg font-semibold mb-2">Web URL</label>
                        <input
                            type="text"
                            value={webUrl}
                        ...
                        />
                        <p className="text-gray-500 text-sm mt-2 mb-1">Enter the full URL, including http:// or https://</p>
                        {webUrlError && <div className="text-xs text-red-500 mt-1">{webUrlError}</div>}
                    </div>
                )}
                {appType === "2" && (
                    <div className="mb-4">
