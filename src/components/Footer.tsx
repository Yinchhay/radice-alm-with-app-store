            ...
            <div className="container mx-auto grid grid-cols-4 gap-8">
                <div className="col-span-2 max-w-[560px]">
                    ...
                    <p>
                        ...
                        their ideas to life through research and development.
                        Radice is passionate about innovation and creativity,
                        and strives to deliver high-quality results
                    </p>
                </div>
                <div>
                ...
                <div>
                    <h2 className="font-bold mb-4 text-xl">Location</h2>
                    <iframe
