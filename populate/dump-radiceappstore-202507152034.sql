...
SET
  @ @GLOBAL.GTID_PURGED =
  /*!80000 '+'*/
  'dda393a2-5589-11f0-8522-daec5656b813:1-4028';
...
CREATE TABLE `bug_reports` (
  ...
  CONSTRAINT `bug_reports_app_id_apps_id_fk` FOREIGN KEY (`app_id`) REFERENCES `apps` (`id`) ON DELETE
  SET
    NULL,
...
CREATE TABLE `feedbacks` (
  ...
  CONSTRAINT `feedbacks_app_id_apps_id_fk` FOREIGN KEY (`app_id`) REFERENCES `apps` (`id`) ON DELETE
  SET
    NULL,
...
(
    154,
    'computer-5751b027-3395-4447-8dec-e7a32d6568be.pdf',
    '3.78 MB',
    'application_form',
    NULL,
    NULL,
...
(
    155,
    '(AY 2024-2025)ICT312-Final Portfolio-3586e982-1306-4e39-a9a4-21cfacf7fbed.pdf',
    '4.68 MB',
    'application_form',
    NULL,
    NULL,
...
(
    156,
    'computer-789e57c3-de34-4878-913f-a8f1b4545c4f.pdf',
    '3.78 MB',
    'application_form',
    NULL,
    NULL,
...
(
    157,
    'computer-2b388404-e80e-459c-8f46-cc08ed2c287f.pdf',
    '3.78 MB',
    'application_form',
    NULL,
    NULL,
...
(
    158,
    'computer-bd7f69c4-13bb-4526-8df1-381b0ce6c9c1.pdf',
    '3.78 MB',
    'application_form',
    NULL,
    NULL,
...
(
    159,
    'computer-533670e9-ed71-46b0-a48c-887ef775339e.pdf',
    '3.78 MB',
    'application_form',
    NULL,
    NULL,
...
(
    160,
    'computer-9c5f9bed-4076-4933-ac0d-0104551a7101.pdf',
    '3.78 MB',
    'application_form',
    NULL,
    NULL,
...
(
    161,
    'computer-ea64e5e9-9578-47e4-a561-dd39b37c2ce2.pdf',
    '3.78 MB',
    'application_form',
    NULL,
    NULL,
...
(
    162,
    'Yinchhay-Im-ICT- Portfolio Report -8fdc1bed-de46-41ab-8549-cae97e8e239c.pdf',
    '1.34 MB',
    'application_form',
    NULL,
    NULL,
...
(
    163,
    'all_mou_reworked (1)-3c4f8036-ed3e-40f6-83d1-544b14578679.pdf',
    '110.78 kB',
    'application_form',
    NULL,
    NULL,
...
(
    ...
    'Permission to change app featured priority',
    1,
    '2025-07-14 08:58:26',
    '2025-07-14 08:58:26'
  );
...
(
    ...
    1,
    18,
    'c5cffac4-5f00-11f0-952a-daec5656b813',
    '2025-07-12 09:17:05',
    '2025-07-12 09:17:05'
  ),
(
    ...
    1,
    21,
    '0a011d1c-5f01-11f0-952a-daec5656b813',
    '2025-07-12 09:19:58',
    '2025-07-12 09:19:58'
  ),
(
    ...
    1,
    21,
    '67a60e01-6094-11f0-952a-daec5656b813',
    '2025-07-14 09:28:48',
    '2025-07-14 09:28:57'
  );
...
(
    '3awpozwoeduiii7mjpqkcip6iqfei73xee3gzstl',
    '316be07f-dac1-439e-bfc8-c6c519f33058',
    '2025-07-26 08:12:19',
    '2025-07-12 08:12:18',
    '2025-07-12 08:12:18'
...
(
    'g3ysh7wudhevwsp2gyredbgqjalfkzlsp3lqdh7t',
    '67a60e01-6094-11f0-952a-daec5656b813',
    '2025-07-28 09:27:34',
    '2025-07-14 09:27:34',
    '2025-07-14 09:27:34'
...
(
    'lhwvh3fcexie32aa2pduy6kmsufuzsk3kdl6fcna',
    '316be07f-dac1-439e-bfc8-c6c519f33058',
    '2025-07-28 15:01:25',
    '2025-07-14 15:01:24',
    '2025-07-14 15:01:24'
...
(
    'pgskbzsao5oh3iqzeundaoamtbrv7jzp3ifm5hcq',
    'c5cffac4-5f00-11f0-952a-daec5656b813',
    '2025-07-26 09:15:55',
    '2025-07-12 09:15:55',
    '2025-07-12 09:15:55'
...
(
    'xv7kzd5exhxdnl63wtxs4hmg4g5l3m4vlouyd5ov',
    '316be07f-dac1-439e-bfc8-c6c519f33058',
    '2025-07-28 14:09:53',
    '2025-07-14 14:09:53',
    '2025-07-14 14:09:53'
...
(18, 'c5cffac4-5f00-11f0-952a-daec5656b813', 1),
(19, '0a011d1c-5f01-11f0-952a-daec5656b813', 1),
(20, '0de18ca4-34ba-11ef-a8f3-bc241176b8c5', 1),
(21, '23771528-6448-11ef-b0a8-bc241176b8c5', 1),
(22, '20dde738-571e-11f0-952a-daec5656b813', 1),
(23, '2f6f7379-4a70-11ef-a8f3-bc241176b8c5', 1),
(24, '33ed2540-5f00-11f0-952a-daec5656b813', 1),
(25, '3c532c4e-654b-11ef-b0a8-bc241176b8c5', 1),
(26, '47f9f608-5f08-11f0-952a-daec5656b813', 1),
(27, 'bcd69b0b-564f-11f0-952a-daec5656b813', 1),
(28, 'd0945bb7-5f04-11f0-952a-daec5656b813', 1),
(29, '67a60e01-6094-11f0-952a-daec5656b813', 1);
...
(
    '40933711-34b1-11ef-a8f3-bc241176b8c5',
    'Putmonyrath',
    'Vann',
    'stylerbabyzzz@gmail.com',
    '$2b$10$Tu1CiVsgg5cFR7kUU9vCHuOJEaxtEzUamoq3QuETfoqSud465AS0e',
    NULL,
    1,
    1,
    'DSC01502_1to1-66cad14e-1124-47e3-94ab-c08c77688e78.png',
    'user',
    '[{\"skill\": \"Laravel\", \"proficiency\": [0, 1]}, {\"skill\": \"Gin-Gonic\", \"proficiency\": [0, 1]}, {\"skill\": \"Nextjs\", \"proficiency\": [0, 1]}, {\"skill\": \"Nuxtjs\", \"proficiency\": [0, 1]}, {\"skill\": \"Cloud Computing\", \"proficiency\": [0, 1]}, {\"skill\": \"MySQL\", \"proficiency\": [0, 1]}, {\"skill\": \"Postgres\", \"proficiency\": [0, 1]}]',
    '',
    '2024-06-27 18:15:36',
    NULL,
    '2024-06-27 18:15:36',
...
(
    '6a10f994-9161-11ef-8abf-bc241176b8c5',
    'Sakvipubp',
    'Suy',
    'sakvipubp.suy1120@gmail.com',
    '$2b$10$DH.0jhNIKDsj4lnCQx876ebuOaAJSZEOdDJC/YyMHldJg/tGOq6ku',
    NULL,
    1,
    1,
    NULL,
...
(
    '82f4a6be-643a-11ef-b0a8-bc241176b8c5',
    'Seavlong',
    'Tang',
    'kohaitang2804@gmail.com',
    '$2b$10$lRrruTlWX2KxJQ9aBKryx.TtG968X5IZtiJRIveWKVJO8KbnTXSta',
    NULL,
    1,
    1,
    '',
...
(
    '882b1ac7-4ffe-11f0-b371-bc241176b8c5',
    'Kolbot',
    'Pen',
    'kolbot.pen@gmail.com',
    '$2b$10$LYfwLUpmfLgtl3SKGinoOOZ90ibnnWkFMhLYKEb4UHFAWtxt.mF6G',
    NULL,
    1,
    1,
    'thebends-a37bc490-7094-471f-ac4d-51ce3f16ebd2.jpeg',
...
(
    '95ed9c5e-643a-11ef-b0a8-bc241176b8c5',
    'Seakliv',
    'Khou',
    'seaklivkhou07@gmail.com',
    '$2b$10$V6Dry7YiWo3rsCGsioOMrOAxDPGc7/jQBX88IoJrdF9NtpS2tVRdO',
    NULL,
    1,
    1,
    NULL,
...
(
    'b6e12c52-4a93-11ef-a8f3-bc241176b8c5',
    'Bit',
    'Pi',
    'bitpiocean@gmail.com',
    '$2b$10$7jWx3NVyb35GnHORjbXlJOxCkIS/9alC.86x8UMnUvt4BelK25otm',
    NULL,
    1,
    1,
    NULL,
...
(
    'bc988008-615b-11ef-a34b-bc241176b8c5',
    'Bunhab',
    'Ung',
    'ubunhab@gmail.com',
    '$2b$10$qGNDy1njZyUwxGgueRJ8l.0Y0zS0TPJIgaop7QF7x4s811rR.2i9i',
    NULL,
    1,
    1,
    'no-profile-picture-icon-12-2f5dc61c-fee8-472c-a068-b7d1dadddfd5.webp',
...
(
    'bec0ee6f-3213-11ef-a8f3-bc241176b8c5',
    'Seakmeng',
    'Hor',
    'shor1@paragoniu.edu.kh',
    '$2b$10$W8dRSoDBhh30Ig7Y/pglvOH0f2XvAiVVEKznqzfYwYcfaAcwt8nRO',
    NULL,
    1,
    1,
    '',
    'user',
    '[{\"skill\": \"C++\", \"proficiency\": [0]}, {\"skill\": \"Typescript\", \"proficiency\": [0, 1]}]',
    '',
    '2024-06-24 10:23:05',
    NULL,
    '2024-06-24 10:23:05',
...
(
    'c7e52a98-615b-11ef-a34b-bc241176b8c5',
    'Sorikan',
    'Bun',
    'bunsorikanz@gmail.com',
    '$2b$10$LhDpc9XRb6ppt7DFkIKb8OWpMA8VuykjCuPksT45qYoAtpqpy99qW',
    NULL,
    1,
    1,
    NULL,
...
(
    'c86452dc-643a-11ef-b0a8-bc241176b8c5',
    'Daravid',
    'Ngauv',
    'daravid5683@gmail.com',
    '$2b$10$JtronY4Zs44pa.3eXwj3wO.7rlYqpGHHyYvMVTGvSWDIEUUzIsPw6',
    NULL,
    1,
    0,
    NULL,
...
(
    'da329b78-6172-11ef-a34b-bc241176b8c5',
    'Mouthe',
    'Ty',
    'freezingraven90@gmail.com',
    '$2b$10$XvveNTjKQZCizdcOcFLyOOiY/I8GAcrz33G.heVLTYayu5yw9K.dK',
    NULL,
    1,
    1,
    NULL,
...
(
    'daf2078e-615b-11ef-a34b-bc241176b8c5',
    'Chanbora',
    'Seng',
    'sengbora2424@gmail.com',
    '$2b$10$Z7bD9mIHxma4BfpEvuyCP.rS5jlE27I2sb9OIjdT3FcCARkk1qspy',
    NULL,
    1,
    1,
    NULL,
...
(
    'f098adbc-65dc-11ef-b0a8-bc241176b8c5',
    'Sokleng',
    'Prom',
    'promsokleng17@gmail.com',
    '$2b$10$iLnBwY/122Gg6cwrx.oq/O3/55tnuEy/mFQomsQkgEw5UwrIS7v8S',
    NULL,
    1,
    1,
    NULL,
...
(
    'feef38b2-5bc9-11ef-a34b-bc241176b8c5',
    'FYP',
    '(Fuel Your Progress)',
    'fypdue.24@gmail.com',
    '$2b$10$.D6cqC7/ld1t5KqTD9zj5.KQKz9RpsAKNo4gmAhe7OV3Kd3CD6bpC',
    NULL,
    1,
    1,
    '',
